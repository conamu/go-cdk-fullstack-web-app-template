module github.com/conamu/go-cdk-fullstack-web-app-template

go 1.22.4

require (
	github.com/Masterminds/semver/v3 v3.2.1 // indirect
	github.com/aws/aws-cdk-go/awscdk/v2 v2.147.0 // indirect
	github.com/aws/constructs-go/constructs/v10 v10.3.0 // indirect
	github.com/aws/jsii-runtime-go v1.100.0 // indirect
